...
function citybi_user_info_store(){
		...
		if (isset($response_data['status']) && $response_data['status']==true) {
			$message = '<div class="billing_user_details">
				...
				<div class="row justify-content-center">
					<div class="col-md-6">
						<div class="billing_user_name">'.$name.'</div>
					...
					<div class="col-md-6">
						<div class="billing_user_mobile">
							<strong>Mobile:</strong><span>'.$mobileNumber.'</span>
						</div>
			...
			<div class="billing_address_details">
				...
				<div class="row justify-content-center">
					<div class="col-md-6">
						<div class="billing_address">'.$yourAddress.'</div>
						<div class="billing_city">'.$address1.'</div>
						<div class="billing_town">'.$address2.'</div>
					</div>
					<div class="col-md-6">
						<div class="billing_country">
							<strong>Country:</strong><span>'.$address3.'</span>
						</div>
						<div class="billing_postcode">
							<strong>postal Code:</strong><span>'.$address4.'</span>
						</div>
					</div>
				</div>
			</div>
			<div class="billing_user_email_sec">
				...
				<div class="user_email"><a href="mailto:'.$email.'">'.$email.'</a></div>
			</div>';
			wp_send_json_success(['message' => $message]);
		}else{
			//return $response_data['message'];  // Return the error message
			return wp_send_json_error(['error' => $response_data['message']]);
		}
	}
}
add_action( 'wp_ajax_user_info_store', 'citybi_user_info_store' );
add_action( 'wp_ajax_nopriv_user_info_store', 'citybi_user_info_store' );
